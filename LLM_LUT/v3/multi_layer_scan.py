...
Assumes per-layer checkpoints generated by expand_ratio.py:
    {checkpoint_root}/checkpoints/l{layer}/g{count}/replacement_l{layer}g{gid}.pt
...
Usage:
    ...
    python multi_layer_scan.py \
        ...
        --output_dir outputs/multi_layer_scan \
        --device cuda:1
"""
...
def load_groups_for_layer(checkpoint_root, layer_id, group_count):
    ...
    Layout: {checkpoint_root}/checkpoints/l{layer_id}/g{group_count}/
    """
    candidates = [
        os.path.join(checkpoint_root, "checkpoints", f"l{layer_id}", f"g{group_count}"),
    ]
...
def main():
    ...
    parser.add_argument("--checkpoint_root", default="outputs", help="Root directory containing checkpoints/l{layer}/g{count}")
    parser.add_argument("--eval_size", type=int, default=128)
    parser.add_argument("--max_seq_len", type=int, default=512)
    parser.add_argument("--batch_size", type=int, default=4)
    parser.add_argument("--output_dir", default="outputs/multi_layer_scan")
