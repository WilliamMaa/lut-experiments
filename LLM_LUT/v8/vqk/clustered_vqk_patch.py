#!/usr/bin/env python3
"""Clustered VQK EvalPatch for v8 unified evaluator."""
...
from vqk.clustered_vqk_linear import ClusteredVQKLinear


class ClusteredVQKPatch(EvalPatch):
    """Replace a single Transformer Linear with clustered VQK weight representation.
    ...
    Args:
        ...
        num_clusters: number of weight-block clusters
    """
    ...
    def __init__(
        ...
        self._replacement: ClusteredVQKLinear = None
    ...
    def install(self, model: nn.Module) -> None:
        self._resolve(model)
        self._replacement = ClusteredVQKLinear(
    ...
    def name(self) -> str:
        return (
            f"clustered_vqk_l{self.layer_idx}_{self.module_path}_"
