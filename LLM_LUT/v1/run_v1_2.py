...
def run_v1_2_experiment(config: V1Config, device_str: str = "cuda:0"):
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="LLM-LUT v1.2 Experiment")
    parser.add_argument("--device", default="cuda:0", help="CUDA device to use (e.g. cuda:0, cuda:3)")
    args = parser.parse_args()

    config = V1Config()
    run_v1_2_experiment(config, device_str=args.device)
