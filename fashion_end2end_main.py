"""
Fashion-MNIST 泛化验证：端到端 + backbone_main 动态注入
核心改动：数据集从 MNIST 换成 Fashion-MNIST
其余架构和训练逻辑与 mnist_end2end_main.py 完全一致
"""
...
def main():
    ...
    print("\n--- Fashion-MNIST 端到端联合训练（动态注入 backbone_main）---")
    best_test_acc = 0.0
    ...
    print("\n" + "=" * 60)
    print("【Fashion-MNIST - 端到端 backbone_main 动态注入 - 最终结果】")
    print("=" * 60)
