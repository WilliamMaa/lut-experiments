...
# 保存基座
torch.save(model.state_dict(), 'model_B_base.pth')
global_beta_weights = model.layer_beta.weights.detach().clone()
print("\n基座模型已保存至 model_B_base.pth")
...
# 保存
torch.save(custom_dataset, 'phase1_20_floats_dataset.pt')
print("\n阶段一完成：数据集已保存至 phase1_20_floats_dataset.pt")
