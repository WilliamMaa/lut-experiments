...
model_B.load_state_dict(torch.load('model_B_reg005_base.pth', map_location=device))
model_B.eval()

dataset_phase1 = torch.load('phase1_reg005_dataset.pt', map_location='cpu', weights_only=False)
